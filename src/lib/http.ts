            ...
            if (isClient) {
                if (!clientLogoutRequest) {
                    ...
                    try {
                        ...
                        // Vì nếu rơi vào trường hợp tại trang login, chúng ta có gọi các API cần access
                        // Mà lại không có access token thì sẽ lại redirect về đâu, và cứ thế nó sẽ bị lặp
                        location.href = "/login";
                    }
                }
            } else {
